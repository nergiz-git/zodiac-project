...
// ✅ SERVICES şəkilləri
import service1 from "../../assets/images/services@2x.png";
import service2 from "../../assets/images/services-3@2x.png";
import service3 from "../../assets/images/services-4@2x.png";
import service4 from "../../assets/images/services-2@2x.png";
import service5 from "../../assets/images/services-1@2x.png";
import service6 from "../../assets/images/services-5@2x.png";
    ...
    <div className="find-container">
      ...
      <div className="input-wrapper">
        <input
          ...
          onChange={(e) => setBirthDate(e.target.value)}
        />
        <button onClick={calculateZodiac}>Find</button>
      </div>

      {zodiac && zodiacData[zodiac] && (
        <div className="result-card">
          <img src={zodiacData[zodiac].img} alt={zodiac} />
          <h2>{zodiac}</h2>
        </div>
      )}
