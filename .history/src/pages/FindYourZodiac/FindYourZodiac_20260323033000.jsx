...
import ariesImg from "../../assets/images/Aries.png";
import taurusImg from "../../assets/images/Taurus.png";
import geminiImg from "../../assets/images/Gemini.png";
import cancerImg from "../../assets/images/Cancer.png";
import leoImg from "../../assets/images/Leo.png";
import virgoImg from "../../assets/images/Virgo.png";
import libraImg from "../../assets/images/Libra.png";
import scorpioImg from "../../assets/images/Scorpio.png";
import sagittariusImg from "../../assets/images/Sagittarius.png";
import capricornImg from "../../assets/images/Capricorn.png";
import aquariusImg from "../../assets/images/Aquarius.png";
import piscesImg from "../../assets/images/Pisces.png";

import services1 from "../../assets/images/services@2x.png";
import services2 from "../../assets/images/services-3@2x.png";
import services3 from "../../assets/images/services-4@2x.png";
import services4 from "../../assets/images/services-2@2x.png";
import services5 from "../../assets/images/services-1@2x.png";
import services6 from "../../assets/images/services-5@2x.png";
  ...
  return (
    <div className="find-container">
      ...
      <section className="services-section">
        ...
        <div className="services-cards">
          <div className="service-card">
            <img src={services1} alt="consultation" />
            <h4>General consultation</h4>
            <p>Astrology is one of the earliest attempts made by man to find the order hidden behind or within the confusing and apparent chaos that exists in the world.</p>
          </div>
          <div className="service-card">
            <img src={services2} alt="personal advice" />
            <h4>Personal life advice</h4>
            <p>Astrology is one of the earliest attempts made by man to find the order hidden behind or within the confusing and apparent chaos that exists in the world.</p>
          </div>
          <div className="service-card">
            <img src={services3} alt="forecast" />
            <h4>Annual forecast</h4>
            <p>Astrology is one of the earliest attempts made by man to find the order hidden behind or within the confusing and apparent chaos that exists in the world.</p>
          </div>
          <div className="service-card">
            <img src={services4} alt="forecast" />
            <h4>Annual forecast</h4>
            <p>Astrology is one of the earliest attempts made by man to find the order hidden behind or within the confusing and apparent chaos that exists in the world.</p>
          </div>
          <div className="service-card">
            <img src={services5} alt="forecast" />
            <h4>Annual forecast</h4>
            <p>Astrology is one of the earliest attempts made by man to find the order hidden behind or within the confusing and apparent chaos that exists in the world.</p>
          </div>
          <div className="service-card">
            <img src={services6} alt="forecast" />
            <h4>Annual forecast</h4>
            <p>Astrology is one of the earliest attempts made by man to find the order hidden behind or within the confusing and apparent chaos that exists in the world.</p>
          </div>
        </div>
